...
export default function LengkapiDataUser4() {
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object().shape({
      ktp: fileValidation(10).required("Harus diisi"),
      kk: fileValidation(10).required("Harus diisi"),
      sip: yup.mixed(),
      bpjsksh: fileValidation(10).required("Harus diisi"),
      bpjsktk: fileValidation(10).required("Harus diisi"),
